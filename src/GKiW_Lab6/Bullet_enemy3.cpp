...
CBullet_Enemy3::CBullet_Enemy3(void) : CSceneObject()
{
...
CBullet_Enemy3::~CBullet_Enemy3(void)
{

}

void CBullet_Enemy3::Initialize(void)
{
...
void CBullet_Enemy3::Update(void)
{
...
void CBullet_Enemy3::Render(void)
{
	glPushMatrix();
