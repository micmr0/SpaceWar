...
CExplosion3::CExplosion3() : CSceneObject()
{
	z = 0;
}


CExplosion3::~CExplosion3(void)
{
}

void CExplosion3::Initialize(void)
{
...
void CExplosion3::Update(void)
{
	z += 0.4;
}

void CExplosion3::Render(void)
{
	glPushMatrix();
